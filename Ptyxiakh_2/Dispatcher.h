...
#include <queue>
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// TO BE DELETED WHEN "CHANGED" HAS BEEN COMPLETED
#include "Core.h"
...
private:
    std::queue<int> disp_job_queue;//queue for incoming random numbers
    std::queue<Core> disp_core_queue; // somehow it should include core handlers
